...
public:
    ...
    //added by Kio
    typedef void (*RawReportCB)(void* user, const uint8_t* report, uint16_t len);
    void onRawReport(RawReportCB cb, void* user = nullptr) {
        raw_cb_ = cb;
        raw_user_ = user;
    }
...
private:
    ...
    //added by Kio
    RawReportCB raw_cb_ = nullptr;
    void* raw_user_ = nullptr;
};
